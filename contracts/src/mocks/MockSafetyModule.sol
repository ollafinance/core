...
contract MockSafetyModule is ISafetyModule {
    ...
    function setMaxQueueRatioBps(uint256 maxQueueRatioBps) external override {
    ...
    function setMaxAccountingDelay(uint256 maxAccountingDelay) external override {
    ...
    function setLastAccountingTimestamp(uint256 lastAccountingTimestamp) external override {
    ...
    function checkWithdrawalMinimum(uint256 assets) external view override {
        _noop(assets);
    }
